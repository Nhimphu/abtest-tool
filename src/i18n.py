...
i18n = {
    "RU": {
        ...
        "help.baseline": "Базовая конверсия",
        "help.uplift": "Ожидаемый uplift варианта",
        "help.alpha": "Уровень значимости",
        "help.power": "Статистическая мощность",
        "help.calc": "Рассчитать размер выборки",
        "help.analyze": "Запустить A/B/n тест",
        "help.confidence": "Построить доверительные интервалы",
        "help.bayesian": "Выполнить байесовский анализ",
        "help.aa": "Запустить A/A симуляцию",
        "help.sequential": "Выполнить последовательный анализ",
        "help.obf": "Анализ O'Brien-Fleming",
        "help.roi": "Рассчитать ROI",
        "help.plot_ci": "График доверительных интервалов",
        "help.plot_power": "Кривая требуемого объёма",
        "help.plot_alpha": "График расхода альфы",
        "help.plot_bootstrap": "Распределение бутстрапа",
        "help.save_plot": "Сохранить последний график",
        "help.load_pre_exp": "Загрузить предэкспериментальные данные",
        "help.clear": "Очистить результаты",
        "help.delete_selected": "Удалить выбранные строки истории",
        "help.clear_history": "Очистить всю историю",
    ...
    "EN": {
        ...
        "help.baseline": "Baseline conversion rate",
        "help.uplift": "Expected uplift of variant",
        "help.alpha": "Significance level",
        "help.power": "Statistical power",
        "help.calc": "Calculate sample size",
        "help.analyze": "Run A/B/n test",
        "help.confidence": "Plot confidence intervals",
        "help.bayesian": "Run Bayesian analysis",
        "help.aa": "Run A/A simulation",
        "help.sequential": "Run sequential analysis",
        "help.obf": "Run O'Brien-Fleming analysis",
        "help.roi": "Calculate ROI",
        "help.plot_ci": "Confidence intervals plot",
        "help.plot_power": "Required sample size curve",
        "help.plot_alpha": "Alpha spending plot",
        "help.plot_bootstrap": "Bootstrap distribution",
        "help.save_plot": "Save last plot",
        "help.load_pre_exp": "Load pre-experiment data",
        "help.clear": "Clear results",
        "help.delete_selected": "Delete selected history rows",
        "help.clear_history": "Clear all history",
